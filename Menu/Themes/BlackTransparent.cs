// <copyright file="BlackTransparent.cs" company="EnsageSharp">
...
namespace Ensage.Common.Menu.Themes
{
    ...
    internal class BlackTransparent : IMenuTheme
    {
        ...
        public string MenuArrowOpen { get; } =
            "materials/ensage_ui/menu/themes/black_transparent/arrowrighthover.vmat_c";
        ...
        public string OnOffSliderBackground { get; } =
            "materials/ensage_ui/menu/themes/black_transparent/sliderbgon.vmat_c";

        /// <summary>
        ///     Gets the on off slider disabled.
        /// </summary>
        public string OnOffSliderDisabled { get; } =
            "materials/ensage_ui/menu/themes/black_transparent/circleshadowgray.vmat_c";

        /// <summary>
        ///     Gets the on off slider enabled.
        /// </summary>
        public string OnOffSliderEnabled { get; } =
            "materials/ensage_ui/menu/themes/black_transparent/circleshadow.vmat_c";
