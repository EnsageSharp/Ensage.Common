...
namespace Ensage.Common.Menu
{
    ...
    internal class MenuUtils
    {
        ...
        ///     The line.
        /// </summary>
        private static readonly Line Line = new Line(Drawing.Direct3DDevice9) { GLLines = true };
            ...
            Color color)
        {
            ...
            Drawing.Direct3DDevice9.SetStreamSource(0, vertices, 0, Utilities.SizeOf<Vector4>() * 2);
            Drawing.Direct3DDevice9.VertexDeclaration = vertexDeclaration;
            Drawing.Direct3DDevice9.DrawPrimitives(PrimitiveType.TriangleFan, 0, resolution);
            Drawing.Direct3DDevice9.VertexDeclaration = olddec;
