// <copyright file="BlueTransparent.cs" company="EnsageSharp">
...
namespace Ensage.Common.Menu.Themes
{
    ...
    internal class BlueTransparent : IMenuTheme
    {
        ...
        public string OnOffSliderBackground { get; } =
            "materials/ensage_ui/menu/themes/blue_transparent/sliderbgon.vmat_c";

        /// <summary>
        ///     Gets the on off slider disabled.
        /// </summary>
        public string OnOffSliderDisabled { get; } =
            "materials/ensage_ui/menu/themes/blue_transparent/circleshadowgray.vmat_c";

        /// <summary>
        ///     Gets the on off slider enabled.
        /// </summary>
        public string OnOffSliderEnabled { get; } =
            "materials/ensage_ui/menu/themes/blue_transparent/circleshadow.vmat_c";
